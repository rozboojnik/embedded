 ...
 *
 * Description:
 *    Implements low-level routines for the I2C bus
 *
 *****************************************************************************/
...
#define I2C_REG_SCLH        25         /* SCL Duty Cycle high register */
#define I2C_REG_SCLH_MASK   0x0000FFFF /* Used bits                    */
#define I2C_REG_SCLL        25         /* SCL Duty Cycle low register  */
